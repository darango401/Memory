...
public class Juego extends Activity {
    ...
    //Variables para los componentes de las vista
    ...
    private void cargarTablero(){
        ...
        //Ahora los voy a cargar en el tablero
        tablero[0] = imb00;
        tablero[1] = imb01;
        tablero[2] = imb02;
        tablero[3] = imb03;
    ...
    private void cargarBotones(){
        ...
        botonSalir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish(); //Finish cierra el activity
            }
        });
    }
    ...
    private ArrayList<Integer> barajar(int longitud){
        ...
        Collections.shuffle(result); //Desordenar resultado
